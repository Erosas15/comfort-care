...
const CareSection = ({ independPageIndex, image }) => {
  const careSectionText = [
    ...
    "Your safety and security are our top priorities. With 24/7 surveillance, secure entry points, and emergency response systems, you can have peace of mind knowing you are well-protected. Live confidently in an environment that prioritizes your well-being, day and night.",
